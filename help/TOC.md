...
# Experience Manager Eventos GEMS {#gems}

+ [Visão geral](overview.md)
+ 2023 {#gems2023}
   + [Certificação AEM - técnica](/help/gems2023/aem-certification-technical.md)
   + [Acelerando o desenvolvimento as a Cloud Service do Experience Manager com ambientes de desenvolvimento rápido](/help/gems2023/Rapid-Development-Environments.md)
...
+ 2018 {#gems2018}
   ...
   + [Experimentos na escalabilidade do AEM Author](gems2018/aem-author-scalability1.md)
...
+ 2017 {#gems2017}
   + [Versão principal do Brand Portal e nova implementação de referência para o Asset Share](/help/gems2017/aem-brand-portal.md)
   + [Criar verificações de integridade para o AEM](/help/gems2017/aem-building-health-checks-for-aem.md)
   + [Desenvolver pacotes e serviços OSGi para AEM](/help/gems2017/aem-developing-osgi-bundles-services-for-aem.md)
   + [Arquitetura do AEM Dynamic Media 6.3](/help/gems2017/aem-dynamic-media-architecture.md)
   + [Experiências fluídas do AEM para casos de uso headless](/help/gems2017/aem-headless-usecases.md)
   + [Indexação de AEM e consulta JCR](/help/gems2017/aem-indexing-jcr-query.md)
   + [Integrações com AEM](/help/gems2017/aem-integrations.md)
   + [Gerenciar o AEM DataStore](/help/gems2017/aem-managing-aem-datastore.md)
   + [Os formulários de busca ficaram simples com o AEM querybuilder](/help/gems2017/aem-search-forms-using-querybuilder.md)
   + [Manutenção do AEM - Práticas recomendadas para implantar versões de manutenção do AEM](/help/gems2017/aem-sustenance-best-practices-deploying-maintenance-releases.md)
   + [No buraco negro do tar: um mergulho profundo do TarMK](/help/gems2017/aem-tarmk-deepdive.md)
   + [Dia difícil2 - Uma ferramenta nova e aprimorada de teste de estresse e benchmarking](/help/gems2017/aem-toughday2-stress-testing-benchmarking-tool.md)
   ...
   + [Solução de problemas de replicação do AEM](/help/gems2017/aem-troubleshooting-aem-replication.md)
   + [Solução de problemas de distribuição de conteúdo do Sling](/help/gems2017/aem-troubleshooting-sling.md)
+ 2016 {#gems2016}
   + [Configurar o DAM para corporações](/help/gems2016/aem-configuring-dam-for-enterprise.md)
   + [Introdução ao AEM Screens](/help/gems2016/aem-introduction-to-aem-screens.md)
   + [Gerencie o conteúdo com o editor de modelo do Adobe Experience Manager](/help/gems2016/aem-managing-content-with-template-editor.md)
   + [Índices Oak Lucene](/help/gems2016/aem-oak-lucene-indexes.md)
   + [Executar AEM no MongoDB](/help/gems2016/aem-running-aem-on-mongodb.md)
   + [Instalar e configurar o AEM Dynamic Media](/help/gems2016/aem-setup-and-configure-aem-dynamic-media.md)
   + [Espiada técnica](/help/gems2016/aem-technical-sneak-peek.md)
   + [Ferramentas a serem usadas para testar aplicativos do Adobe Experience Manager](/help/gems2016/aem-testing-tools-for-aem-apps.md)
   + [Utilizar SAML em implantações do Adobe Experience Manager](/help/gems2016/aem-utilizing-saml-in-aem-deployments.md)
   + [Desempenho da Web no AEM](/help/gems2016/aem-web-performance.md)
+ 2015 {#gems2015}
   + [Integração e práticas recomendadas de tradução do AEM 6.1](/help/gems2015/aem-6-1-translation-integration-and-best-practices.md)
   + [Criar comunidades online com o AEM 6.1](/help/gems2015/aem-creating-online-communities-with-aem-6-1.md)
   + [Personalizar campos de caixa de diálogo na interface para toque](/help/gems2015/aem-customizing-dialog-fields-in-touch-ui.md)
   + [Aprofundamento do processo de atualização do AEM](/help/gems2015/aem-deep-dive-into-aem-upgrade-process.md)
   + [Cache do Dispatcher - Novos recursos e otimizações](/help/gems2015/aem-dispatcher-caching-new-features-and-optimizations.md)
   + [AEM [!DNL Forms] introdução ao pacote de recursos 1 e amostras técnicas](/help/gems2015/aem-forms-feature-pack-1-introduction-and-technical-samples.md)
   ...
   + [Sonar - Um elemento-chave para melhorar a qualidade do produto](/help/gems2015/aem-sonar-a-key-element-to-improve-product-quality.md)
   + [AEM Tech Speak Peek](/help/gems2015/aem-tech-sneak-peek.md)
   + [Dicas e truques para [!DNL AEM Sites] Interface para toque](/help/gems2015/aem-tips-and-tricks-for-aem-sites-touch-ui.md)
   + [Rastrear as métricas de qualidade do seu projeto JavaScript](/help/gems2015/aem-track-quality-metrics-of-your-javascript-project.md)
+ 2014 {#gems2014}
   + [Implantar o Adobe Analytics em uma instância local do AEM por meio do serviço de nuvem DTM](/help/gems2014/aem-adobe-analytics-dynamic-tag-management.md)
   + [Como aproveitar ao máximo seu pacote de recursos DAM](/help/gems2014/aem-dam-feature-pack.md)
   + [Entrega de conteúdo gerenciado aos aplicativos nativos](/help/gems2014/aem-delivering-managed-content-to-your-native-apps.md)
   ...
   + [Crie componentes reutilizáveis com eficiência](/help/gems2014/aem-efficiently-build-reusable-components.md)
   + [Introdução ao HTL](/help/gems2014/aem-introduction-to-htl.md)
   + [Tradução automática no AEM](/help/gems2014/aem-machine-translation-in-aem.md)
   ...
   + [SharePoint Connector - Instalação e configuração](/help/gems2014/aem-sharepoint-connector-setup-and-configuration.md)
   + [Estrutura de componente social no AEM 6](/help/gems2014/aem-social-component-framework-in-aem-6.md)
   ...
   + [Personalização da interface do usuário para AEM 6](/help/gems2014/aem-user-interface-customization-for-aem6.md)
+ 2013 {#gems2013}
   ...
   + [integração de estrutura de comércio eletrônico hybris/AEM 5.6](/help/gems2013/aem-hybris-ecommerce-framework-integration.md)
   + [Introdução ao manuseio e descarregamento de trabalhos no AEM 5.6.1.](/help/gems2013/aem-job-handling-and-offloading.md)
   + [Lançamentos - preparação simultânea de várias versões de um site (AEM 5.6)](/help/gems2013/aem-launches.md)
   + [Aprofundamento do Editor de mídia AEM 5.6](/help/gems2013/aem-media-publisher-deep-dive.md)
   + [Gerenciamento de metadados no DAM do AEM](/help/gems2013/aem-metadata-management-in-aem-dam.md)
   + [Desenvolvimento para dispositivos móveis com o CQ facilitado](/help/gems2013/aem-mobile-first-development-with-cq-made-easy.md)
   + [Simplificação do processo de conteúdo multilíngue](/help/gems2013/aem-streamlining-multilingual-content-process.md)
   + [Mecanismos de atualização do AEM 5.6](/help/gems2013/aem-upgrade-mechanisms.md)
